  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Hi, my name is Jens Haase and this is my personal blog about bikepacking and bike touring. Here, I will write down about the adventures I made along my way.' }
    ],
    link: [
